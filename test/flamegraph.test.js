...
describe('TransformedData', function () {
  ...
  describe('valid profile', function () {
    it('transforms valid data correctly', function () {
      const validProfile = {
        nodes: [
          { id: 1, selfTime: 100, children: [2, 3], callFrame: { functionName: 'root', url: 'root.js' } },
          { id: 2, selfTime: 50, children: [], callFrame: { functionName: 'child1', url: 'child1.js' } },
          { id: 3, selfTime: 50, children: [], callFrame: { functionName: 'child2', url: 'child2.js' } }
        ],
