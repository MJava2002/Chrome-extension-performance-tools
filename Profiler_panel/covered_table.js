...
export function drawTable(data) {
  ...
  // Create header row
  const headerRow = createCoverageTableRow('header', 'Filename', 'Bytes Covered', 'Coverage');
  ...
  data.forEach((item, index) => {
    ...
    const row = createCoverageTableRow(containerId, item.filename, item.bytesCovered, item.percentageCovered);
...
function createCoverageTableRow(containerId, filename, bytesCovered, coverageLabel) {
